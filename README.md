...
> honest `partial` status when execution did not reach every declared step; auto-generating specs
> from cases has not started yet. The agent layer (`qa-start`, `qa-explore`, `qa-design-cases`) and
