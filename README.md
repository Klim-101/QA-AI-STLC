...
| **Generates Playwright tests**, for the UI and for the API from your OpenAPI contract, that are verified by execution before they are kept and run in CI without any model.                                                                                                                                                                        | Planned                                               | Phase 3; the generation contract and its verification loop (typecheck + execute against a real runner before registration, ADR-0010) are built, but the generator itself has not started yet. |
